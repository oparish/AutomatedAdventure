...
{	
	...
	QUALITY_NAME("qualityName", STRING, JsonDim.MONO),
	SELECTION_TYPE("selectionType", STRING, JsonDim.MONO),
	...
	STRING_VALUE("stringValue", STRING, JsonDim.MONO),
	...
	ADD_ELEMENT_TO_CONTEXT("addElementToContext", STRING, JsonDim.MONO),
	...
	GROUP_NAME("groupName", STRING, JsonDim.MONO),
